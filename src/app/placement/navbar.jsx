...
const CompNav = () => {
  return (
    <div className="h-full  sm:w-3/12 lg:w-2/12 bg-slate-500 border-slate-400 border-solid border-2 rounded-md p-2  flex-col gap-5 overflow-y-auto">
      <div className="h-full sflex-col gap-5 overflow-y-auto ">
